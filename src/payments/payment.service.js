...
// 👁️  SECURITY SENSITIVE FIX: Use environment variables instead of hardcoded keys
const STRIPE_SECRET_KEY = process.env.STRIPE_SECRET_KEY || 'stripe_key_placeholder';
